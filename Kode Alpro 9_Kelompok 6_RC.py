...
class StudentProductivityToolkit:
    ...
    # Mendefinisikan fungsi motivasi
    def tampilkan_motivasi(self):
        ...
        motivasi = [
            ...
            "Kesuksesan datang dari kerja keras dan ketekunan.",
            "Setiap langkah kecil menuju tujuan adalah langkah menuju kesuksesan"
        ]
        # Tampilkan motivasi acak
